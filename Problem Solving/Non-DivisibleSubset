...
Difficulty:         Medium
Problem Author:     zxqfd555     (https://www.hackerrank.com/profile/zxqfd555)
...
int nonDivisibleSubset(int k, vector<int> s) {
    int result = 0;
    int count = 0;
    vector<int> frequency = vector<int>(k,0);
    ...
    if (frequency[0] > 0) result ++;
    if (k%2 == 0 && frequency[k/2]!=0) result++;
